...
const DJOverview: React.FC = () => {
    ...
    const scheduleData = [
        { id: 1, time: 'Tonight, 8:00 PM - 10:00 PM', show: 'Night Grooves', status: 'Upcoming' },
        ...
        { id: 4, time: 'Saturday, 12:00 PM', show: 'Weekend Brunch', status: 'Upcoming' },
    ];
  ...
  return (
    <>
        <h2 className="text-2xl font-bold text-white mb-6">DJ Dashboard</h2>
                ...
                {/* Live Studio */}
                 <div className="bg-gray-800/50 rounded-lg border border-gray-700/50 shadow-lg">
                    <div className="p-4 border-b border-gray-700 flex items-center">
                        ...
                        <h3 className="text-lg font-semibold text-white">Live Studio</h3>
                    </div>
                    <div className="p-6">
                        <div className="flex flex-col sm:flex-row items-center justify-between">
                            <div>
                                <h4 className="text-xl font-bold text-white">The Night Shift</h4>
                        ...
                        {isOnAir && (
                             <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="bg-gray-700/50 p-4 rounded-lg">
                                    ...
                                    <p className="font-semibold text-white truncate">Starlight - MUSE</p>
                                </div>
                                <div className="bg-gray-700/50 p-4 rounded-lg">
                                    <p className="text-sm text-gray-400">Up Next</p>
                                    <p className="font-semibold text-white truncate">Listener Request: Blinding Lights</p>
                                </div>
                            </div>
                        )}
                    </div>
            ...
            <div className="space-y-8">
                 <div className="bg-gray-800/50 rounded-lg border border-gray-700/50 shadow-lg">
                    <div className="p-4 border-b border-gray-700 flex items-center">
                        ...
                        <h3 className="text-lg font-semibold text-white">My Schedule</h3>
                    </div>
                    <div className="p-4">
